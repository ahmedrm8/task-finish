              ...
              <div class="table-responsive mb-4">
                <table class="table">
                  ...
                  <?php
                    ...
                    $select_cart = "SELECT cart.*, products.* FROM `cart` INNER JOIN `products` ON cart.cart_pro_id = products.pro_id AND cart.cart_user_id = '$user_id'";
                    ...
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        ...
                        <?php
                          ...
                          ?>
                        <img src="../sb-admin/images/<?php echo $image[0]; ?>" alt="..." width="70"/>
                        </a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.html"><?= $cart['pro_name']; ?></a></strong></div>
                        </div>
                      </th>
                      <td class="align-middle border-0">
                        <p class="mb-0 small">$<?= $cart['pro_price'] ?></p>
                      </td>
                      <td class="align-middle border-0">
                        <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                          <div class="quantity">
                            <button class="dec-btn p-0"><i class="fas fa-caret-left"></i></button>
                            <input class="form-control form-control-sm border-0 shadow-0 p-0" type="text" value="<?= $cart['count'] ?>"/>
                            <button class="inc-btn p-0"><i class="fas fa-caret-right"></i></button>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle border-0"><a class="reset-anchor" href="functions/delcart.php?id=<?= $cart['cart_id']; ?>"><i class="fas fa-trash-alt small text-muted"></i></a></td>
                    </tr>
                    <?php
                    }?>
                  </tbody>
