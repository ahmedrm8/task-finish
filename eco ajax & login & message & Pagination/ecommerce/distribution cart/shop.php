              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <?php
                  ...
                  if (isset($_GET['page'])) {
                    ...
                    $select_pro = "SELECT * FROM products LIMIT $start, $rows_per_page";
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        ...
                        <?php
                        $json = $product['pro_img'];
                        $image = json_decode($json, true);
                          ?>  
                        <img class="img-fluid w-100" style="height:280px;" src="../sb-admin/images/<?= $image[0] ?>" alt="...">
                      </a>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="functions/addcart.php?id=<?= $product['pro_id']; ?>">Add to cart</a></li>
                            <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark" href="?id=<?= $product['pro_id']; ?>" data-toggle="modal"><i class="fas fa-expand"></i></a></li>
                          </ul>
                        </div>
                      </div>
                      <h6> <a class="reset-anchor" href="detail.html"><?= $product['pro_name'] ?></a></h6>
                      <p class="small text-muted">$<?= $product['pro_price'] ?></p>
                    </div>
                  </div>
                  <?php
                  }
                ...
                <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-center justify-content-lg-end">
                    ...
                    ?>  
                    <a class="page-link" href="?page=<?= $_GET['page'] - 1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a>
                      <?php
                      } else {
                        ?>
                  ...
                  ?>
                    ...
                    <?php
                      ...
                      ?>
                      <a class="page-link" href="?page=<?= $_GET['page'] + 1 ?>"><span>»</span></a>
                      <?php
                    }
