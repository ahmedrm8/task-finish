...
if (isset($_SESSION['login_username'])) {
    ?>
                      <a class="nav-link" style="cursor:pointer;" data-toggle="modal" data-target="#logout">
    ...
    ?>
                      <a class="nav-link" style="cursor:pointer;" href="../sb-admin/functions/logout.php">
                        <i class="fas fa-user-alt mr-1 text-gray"></i>
                        Login
                      </a>
                      <?php
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="../sb-admin/functions/logout.php" type="button" class="btn btn-primary">Confirm</a>
      </div>
    </div>
  </div>
</div>
